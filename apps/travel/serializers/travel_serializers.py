...
class TravelApplicationSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if not trip_details_data:
            raise serializers.ValidationError("At least one trip detail is required")
        
        user = self.context['request'].user

        # Validate dates
        for trip_data in trip_details_data:
            departure = trip_data['departure_date']
            ...
            # Check for duplicate travel requests if creating new
