...
import { GUEST_HOUSES } from "../lib/travel-constants";
...
export const GuestHouseSelector: React.FC<GuestHouseSelectorProps> = ({
  selectedPreferences,
  ...
  return (
    <div className="space-y-1.5">
      <label className="block text-sm font-medium text-foreground">
        Guest House Preferences <span className="text-destructive">*</span>
      </label>
        ...
        {isOpen && (
          <>
            ...
            <div className="absolute top-full right-0 mt-2 w-96 bg-popover border border-border rounded-lg shadow-xl z-50 animate-slide-up">
              <div className="p-4">
                <div className="mb-4">
                  <h3 className="text-sm font-semibold text-foreground">Guest House Preferences</h3>
